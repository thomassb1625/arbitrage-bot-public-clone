...
func (_Vault *VaultCaller) GetNextNonce(opts *bind.CallOpts, account common.Address) (*big.Int, error) {
	var out []interface{}
	err := _Vault.contract.Call(opts, &out, "getNextNonce", account)
...
//
// Solidity: function getNextNonce(address account) view returns(uint256)
func (_Vault *VaultSession) GetNextNonce(account common.Address) (*big.Int, error) {
	return _Vault.Contract.GetNextNonce(&_Vault.CallOpts, account)
}

// GetNextNonce is a free data retrieval call binding the contract method 0x90193b7c.
//
// Solidity: function getNextNonce(address account) view returns(uint256)
func (_Vault *VaultCallerSession) GetNextNonce(account common.Address) (*big.Int, error) {
	return _Vault.Contract.GetNextNonce(&_Vault.CallOpts, account)
}
...
func (_Vault *VaultCaller) QueryBatchSwap(opts *bind.CallOpts, kind uint8, swaps []IVaultBatchSwapStep, assets []common.Address, funds IVaultFundManagement) ([]*big.Int, error) {
	var out []interface{}
	err := _Vault.contract.Call(opts, &out, "queryBatchSwap", kind, swaps, assets, funds)
...
//
// Solidity: function queryBatchSwap(uint8 kind, (bytes32,uint256,uint256,uint256,bytes)[] swaps, address[] assets, (address,bool,address,bool) funds) view returns(int256[])
func (_Vault *VaultSession) QueryBatchSwap(kind uint8, swaps []IVaultBatchSwapStep, assets []common.Address, funds IVaultFundManagement) ([]*big.Int, error) {
	return _Vault.Contract.QueryBatchSwap(&_Vault.CallOpts, kind, swaps, assets, funds)
}

// QueryBatchSwap is a free data retrieval call binding the contract method 0xf84d066e.
//
// Solidity: function queryBatchSwap(uint8 kind, (bytes32,uint256,uint256,uint256,bytes)[] swaps, address[] assets, (address,bool,address,bool) funds) view returns(int256[])
func (_Vault *VaultCallerSession) QueryBatchSwap(kind uint8, swaps []IVaultBatchSwapStep, assets []common.Address, funds IVaultFundManagement) ([]*big.Int, error) {
	return _Vault.Contract.QueryBatchSwap(&_Vault.CallOpts, kind, swaps, assets, funds)
}
